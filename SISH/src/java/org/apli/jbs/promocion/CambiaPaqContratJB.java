 ...
 * @author ERJI
 */
@ManagedBean(name = "CambiaPaqContratJB")
@SessionScoped

public class CambiaPaqContratJB implements Serializable, Converter {
    ...
    private static CambiaPaqContratJB oCambiaPaqContrat;
        ...
        if (oPaciente != null) {
            if (oPaciente.getFallecido() != true) {
                ...
                if (oPaqueteContratado != null) {
                    ...
                    lPaquetes = oPaqueteContratado.getPaquete().buscaTodosPaquetesTipo();
    ...
    public void cambiaPaqueteContratado() throws Exception {
        oPaqueteContratado.setPaquete(oPaqueteSeleccionado);
        String msj = oPaqueteContratado.cambiaPaqueteContratado();
        if (!msj.contains("ERROR") && !msj.contains("ADVERTENCIA")) {
            ...
            FacesContext facesContext = FacesContext.getCurrentInstance();
            facesContext.getExternalContext().redirect("cambioPaqContra.xhtml");
        } else {
    ...
    public CambiaPaqContratJB getCambiaPaqContrat() {
        return CambiaPaqContratJB.oCambiaPaqContrat;
    }
